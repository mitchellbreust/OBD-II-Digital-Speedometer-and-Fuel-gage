...
- **Data Access service:** A service built with flask to interact with postgres database and retrieve requested data
- **Dashbored service:** Service built with dash to serve graphs and analytics to user
